  ...
  return (
    <>
      <h2 className="flex text-sm font-semibold text-zinc-900 dark:text-zinc-100">
        ...
        <span className="ml-3">Stay in the know - subscribe now!</span>
      </h2>
      <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
        Want to hear my latest tech jokes and puns? Email me now and we'll see
        if you have what it takes to join the elite circle of tech-savvy
        comedians. And don't worry, if you can't handle the laughter, you can
        unsubscribe by sending me a frowny face emoji.
      </p>
      <MailLink href="mailto:rural_archive.0@icloud.com" icon={MailIcon}>
