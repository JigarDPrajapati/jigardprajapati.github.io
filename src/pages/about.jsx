  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Coding with Jigar D. Prajapati: Discovering the Universe with Fun and Humor!"
        />
      </Head>
        ...
        <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
          ...
          <div className="lg:order-first lg:row-span-2">
            <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
              Coding with Jigar D. Prajapati: Discovering the Universe with Fun and Humor!
            </h1>
            <div className="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400">
              <p>
                Hello there! Welcome to my personal website, where you can get
                to know me a little better. My name is Jigar D. Prajapati, and I am
              ...
              <p>
                ...
                sorts of fun activities. I love trying out new recipes in the
                kitchen.
              </p>
              <p>
